...
<img src="{{ site.url }}/assets/operators/start.png" width="640" height="260" />
...
<img src="{{ site.url }}/assets/operators/toAsync.png" width="640" height="310" />
...
<img src="{{ site.url }}/assets/operators/startFuture.png" width="640" height="240" />
...
<img src="{{ site.url }}/assets/operators/deferFuture.png" width="640" height="340" />
...
<img src="{{ site.url }}/assets/operators/forEachFuture.png" width="640" height="415" />
...
<img src="{{ site.url }}/assets/operators/fromAction.png" width="640" height="310" />
...
<img src="{{ site.url }}/assets/operators/fromCallable.png" width="640" height="310" />

***

## fromRunnable( )
#### convert a Runnable into an Observable that invokes the runable and emits its result when a Subscriber subscribes
<img src="{{ site.url }}/assets/operators/fromRunnable.png" width="640" height="310" />
